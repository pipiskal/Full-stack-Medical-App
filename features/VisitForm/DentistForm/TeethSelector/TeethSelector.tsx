...
import { TeethSelectorStateType } from '@/types';

import s from './TeethSelector.module.scss';

type TeethSelectorPropsType = {
  isReadOnly: boolean;
  selectedTeeth: TeethSelectorStateType;
  handleToothSelection: (teeth: TeethSelectorStateType) => void;
};
...
const TeethSelector = ({
  ...
  const handleToothClick = (
    ...
    if (!isReadOnly) {
      ...
      const tooth = e.target as HTMLElement;
      const toothId = tooth.id;

      if (selectedTeeth && selectedTeeth.includes(toothId)) {
        handleToothSelection(selectedTeeth.filter((item) => item !== toothId));
      }

      if (selectedTeeth && !selectedTeeth.includes(toothId)) {
        handleToothSelection([...selectedTeeth, toothId]);
      }
  ...
  const handleActiveToothStyle = (toothId: string) => {
    let style = '';

    if (selectedTeeth && selectedTeeth.includes(toothId)) {
      style = s.selected_tooth;
    }

    if (isReadOnly && selectedTeeth && selectedTeeth.includes(toothId)) {
      style = s.read_only;
    }
  ...
  return (
    <div className={s.tooth_chart}>
      <svg
        ...
        xmlSpace="preserve"
      >
        <g id="toothLabels" className={s.numbers_wrapper}>
          <text id="txt48" transform="matrix(1 0 0 1 97.9767 402.1409)">
            48
          </text>
          <text id="txt47" transform="matrix(1 0 0 1 94.7426 449.1693)">
            47
          </text>
          <text id="txt46" transform="matrix(1 0 0 1 106.0002 495.5433)">
            46
          </text>
          <text id="txt45" transform="matrix(1 0 0 1 118.0002 538.667)">
            45
          </text>
          ...
          <text id="txt43" transform="matrix(1 0 0 1 157.3335 603.8164)">
            43
          </text>
          <text id="txt42" transform="matrix(1 0 0 1 179.3335 623.8164)">
            42
          </text>
          <text id="txt41" transform="matrix(1 0 0 1 204.6669 628.483)">
            41
          </text>
          <text id="txt31" transform="matrix(1 0 0 1 231.3335 628.1497)">
            31
          </text>
          <text id="txt32" transform="matrix(1 0 0 1 256.3335 619.1497)">
            32
          </text>
          <text id="txt33" transform="matrix(1 0 0 1 276.3335 602.483)">
            33
          </text>
          <text id="txt34" transform="matrix(1 0 0 1 286.6669 573.1497)">
            34
          </text>
          <text id="txt35" transform="matrix(1 0 0 1 303.6327 538.667)">
            35
          </text>
          <text id="txt36" transform="matrix(1 0 0 1 322.983 495.5432)">
            36
          </text>
          <text id="txt37" transform="matrix(1 0 0 1 325.1251 449.1686)">
            37
          </text>
          <text id="txt38" transform="matrix(1 0 0 1 324.0004 402.1405)">
            38
          </text>
          <text id="txt28" transform="matrix(1 0 0 1 312.8534 324.1021)">
            28
          </text>
          <text id="txt27" transform="matrix(1 0 0 1 315.3335 275.3333)">
            27
          </text>
          <text id="txt26" transform="matrix(1 0 0 1 311.3335 236)">
            26
          </text>
          <text id="txt25" transform="matrix(1 0 0 1 300.3335 200.6667)">
            25
          </text>
          <text id="txt24" transform="matrix(1 0 0 1 286.6669 172)">
            24
          </text>
          <text id="txt23" transform="matrix(1 0 0 1 270.2269 142.439)">
            23
          </text>
          <text id="txt22" transform="matrix(1 0 0 1 247.5099 118.9722)">
            22
          </text>
          <text id="txt21" transform="matrix(1 0 0 1 227.8432 112.9722)">
            21
          </text>
          <text id="txt11" transform="matrix(1 0 0 1 200.1766 112.9722)">
            11
          </text>
          <text id="txt12" transform="matrix(1 0 0 1 170.5099 117.6388)">
            12
          </text>
          <text id="txt13" transform="matrix(1 0 0 1 148.6667 134.167)">
            13
          </text>
          <text id="txt14" transform="matrix(1 0 0 1 131.3605 164.8335)">
            14
          </text>
          <text id="txt15" transform="matrix(1 0 0 1 119.3927 195.6387)">
            15
          </text>
          <text id="txt16" transform="matrix(1 0 0 1 103.8631 234.4391)">
            16
          </text>
          <text id="txt17" transform="matrix(1 0 0 1 96.2504 275.9999)">
            17
          </text>
          <text id="txt18" transform="matrix(1 0 0 1 93.9767 324.769)">
            18
          </text>
        </g>

        <g id="Spots" className={s.teeth_wrapper}>
          <polygon
            onClick={handleToothClick}
            className={handleActiveToothStyle('48')}
            id="48"
            fill="currentColor"
            data-key="48"
		...
		80.7,375 73.7,371.3 	"
          ...
          <polygon
            onClick={handleToothClick}
            className={handleActiveToothStyle('47')}
            id="47"
            fill="currentColor"
            data-key="47"
		...
		46.7,476.7 37.7,446.3 39.7,438.3 43.3,432 49,426.7 56,424.7 65,424.7 	"
          ...
          <polygon
            onClick={handleToothClick}
            className={handleActiveToothStyle('46')}
            id="46"
            fill="currentColor"
            data-key="46"
		...
		60.3,529.7 56.3,523.7 51.7,511 47.7,494.7 47.7,488.3 50.3,483.3 55,479.7 67,476.7 	"
          ...
          <polygon
            onClick={handleToothClick}
            className={handleActiveToothStyle('45')}
            id="45"
            fill="currentColor"
            data-key="45"
		...
		98.3,578.3 88,579 82,575 75,565 69.3,552.3 67.3,542 69.7,536 74.3,531.7 84.3,528.3 	"
          ...
          <path
            onClick={handleToothClick}
            className={handleActiveToothStyle('44')}
            id="44"
            fill="currentColor"
            data-key="44"
		...
		l-7.3-7l-5-9l-2-10c0,0-0.7-7,0.3-7.3c1-0.3,5.3-6.7,5.3-6.7l9-5H117.3z"
          ...
          <polygon
            onClick={handleToothClick}
            className={handleActiveToothStyle('43')}
            id="43"
            fill="currentColor"
            data-key="43"
		...
		133.3,641.3 128.7,634.7 128.7,629 132.7,621.3 137.7,615 143.7,611 149.7,610 	"
          ...
          <polygon
            onClick={handleToothClick}
            className={handleActiveToothStyle('42')}
            id="42"
            fill="currentColor"
            data-key="42"
		...
		168,656.3 159.3,649.7 156.7,644 162,639.3 	"
          ...
          <polygon
            onClick={handleToothClick}
            className={handleActiveToothStyle('41')}
            id="41"
            fill="currentColor"
            data-key="41"
		...
		190.3,662.7 193,657.3 199.7,647.3 207,638 210.7,635.5 	"
          ...
          <path
            onClick={handleToothClick}
            className={handleActiveToothStyle('31')}
            id="31"
            fill="currentColor"
            data-key="31"
		...
		l-10,0.3h-10l-2-6.7l2.7-7.3L235.3,637z"
          ...
          <polygon
            onClick={handleToothClick}
            className={handleActiveToothStyle('32')}
            id="32"
            fill="currentColor"
            data-key="32"
		...
		292,643.3 291.3,650 287,655 280.7,658.7 272,660 265,660.7 261.3,657.3 261.7,650 263.7,637 264.3,627 	"
          ...
          <polygon
            onClick={handleToothClick}
            className={handleActiveToothStyle('33')}
            id="33"
            fill="currentColor"
            data-key="33"
		...
		321,630 321.3,620.3 317,614.3 308,608 298.3,607 291,609.3 287,612.3 286.7,617.7 287.3,624.7 	"
          ...
          <polygon
            onClick={handleToothClick}
            className={handleActiveToothStyle('34')}
            id="34"
            fill="currentColor"
            data-key="34"
		...
		342.7,604 337.7,609 328,612.7 320,613.3 315,611 308.3,604.7 306.7,598 307.3,591.3 309,584.7 312.7,578.3 318.3,571.7 	"
          ...
          <polygon
            onClick={handleToothClick}
            className={handleActiveToothStyle('35')}
            id="35"
            fill="currentColor"
            data-key="35"
		...
		381.3,524.3 374,520.7 363.7,516.3 356.3,515.3 351.3,518.3 346.3,524 340.3,534.3 336,546.7 	"
          ...
          <path
            onClick={handleToothClick}
            className={handleActiveToothStyle('36')}
            id="36"
            fill="currentColor"
            data-key="36"
		...
		c-0.3-1.3-0.3-11-0.3-11l3.7-14.3l3.7-7l5.3-6.7l8-2l9.7-0.7L398,470z"
          ...
          <polygon
            onClick={handleToothClick}
            className={handleActiveToothStyle('37')}
            id="37"
            fill="currentColor"
            data-key="37"
		...
		407.7,427.3 	"
          ...
          <polygon
            onClick={handleToothClick}
            className={handleActiveToothStyle('38')}
            id="38"
            fill="currentColor"
            data-key="38"
		...
		406.7,395 401,377.7 397.3,373 390.7,367.3 380,365 373,366.7 367.3,369 364,374.3 360,389 363.3,401.3 367.7,412.3 	"
          ...
          <polygon
            onClick={handleToothClick}
            className={handleActiveToothStyle('28')}
            id="28"
            fill="currentColor"
            data-key="28"
		...
		369,339.7 359,335 354.7,327.7 354.3,316 358.3,304 363.7,294 368.7,294.7 378.7,296 389,296 	"
          ...
          <polygon
            onClick={handleToothClick}
            className={handleActiveToothStyle('27')}
            id="27"
            fill="currentColor"
            data-key="27"
		...
		371,294.3 392,295 404.3,293.7 410,280.7 412,263.3 407.3,246.7 401,240.3 396,239.7 389.3,243 	"
          ...
          <polygon
            onClick={handleToothClick}
            className={handleActiveToothStyle('26')}
            id="26"
            fill="currentColor"
            data-key="26"
		...
		393,196 399.3,207 401.3,222.7 400,234.3 394.7,240.7 381.7,244.7 371,246 	"
          ...
          <polygon
            onClick={handleToothClick}
            className={handleActiveToothStyle('25')}
            id="25"
            fill="currentColor"
            data-key="25"
		...
		383.3,178.3 	"
          ...
          <polygon
            onClick={handleToothClick}
            className={handleActiveToothStyle('24')}
            id="24"
            fill="currentColor"
            data-key="24"
		...
		348.7,122.7 354.3,127.7 	"
          ...
          <polygon
            onClick={handleToothClick}
            className={handleActiveToothStyle('23')}
            id="23"
            fill="currentColor"
            data-key="23"
		...
		297.3,120.3 294,112 295.7,102.7 299,95 303.3,90 309.3,88 316.3,87.3 322.7,87.3 328,88.3 	"
          ...
          <polygon
            onClick={handleToothClick}
            className={handleActiveToothStyle('22')}
            id="22"
            fill="currentColor"
            data-key="22"
		...
		274.7,54.7 282,53 287.7,54.7 297.3,60.3 304,64.3 308.7,68.7 312.3,74 313,81 	"
          ...
          <polygon
            onClick={handleToothClick}
            className={handleActiveToothStyle('21')}
            id="21"
            fill="currentColor"
            data-key="21"
		...
		222,58.3 219,50 220,44.3 224.3,40.3 230,38.7 237.3,38.7 253,39.3 258.7,41.3 264.3,43.7 268.3,45.7 	"
          ...
          <polygon
            onClick={handleToothClick}
            className={handleActiveToothStyle('11')}
            id="11"
            fill="currentColor"
            data-key="11"
		...
		212.3,75.7 208,83 201.7,85.7 195.7,86.7 189.7,83.3 183.7,74.7 175,62 171.7,54 172.7,49.7 	"
          ...
          <path
            onClick={handleToothClick}
            className={handleActiveToothStyle('12')}
            id="12"
            fill="currentColor"
            data-key="12"
		...
		l-6.3-5.3l-1-4.3l1.3-5c0,0,3.3-6,4.3-6s5.3-6,6.3-6s10.3-4.7,10.3-4.7L167,55z"
          ...
          <polygon
            onClick={handleToothClick}
            className={handleActiveToothStyle('13')}
            id="13"
            fill="currentColor"
            data-key="13"
		...
		131.3,125 121,125 114.7,119.3 110.3,112.3 108.3,104.7 108.7,94.7 110.7,88.7 116,84 	"
          ...
          <polygon
            onClick={handleToothClick}
            className={handleActiveToothStyle('14')}
            id="14"
            fill="currentColor"
            data-key="14"
		...
		105.7,162.3 96.7,161 85.7,156 82,150 81,139.3 86.3,128 93,121.3 100.7,117.3 	"
          ...
          <polygon
            onClick={handleToothClick}
            className={handleActiveToothStyle('15')}
            id="15"
            fill="currentColor"
            data-key="15"
		...
		73.7,201 64.3,196.7 60.3,190.7 59,183.3 61.7,175.3 66.3,167.7 71.3,161.3 	"
          ...
          <path
            onClick={handleToothClick}
            className={handleActiveToothStyle('16')}
            id="16"
            fill="currentColor"
            data-key="16"
		...
		l5-7.3l4-3.3l4.7-2.7l5.3,3.7l6.7,1.3c0,0,7.3,1.3,9.3,1.3s6.3,0.7,6.3,0.7L92.7,207.3z"
          ...
          <polygon
            onClick={handleToothClick}
            className={handleActiveToothStyle('17')}
            id="17"
            fill="currentColor"
            data-key="17"
		...
		50.3,246.7 56,249 65.3,250.7 74,249.7 80.3,249.7 82.3,254 85.3,259.3 87,267.7 87.7,274.7 85.3,282.7 	"
          ...
          <polygon
            onClick={handleToothClick}
            className={handleActiveToothStyle('18')}
            id="18"
            fill="currentColor"
            data-key="18"
