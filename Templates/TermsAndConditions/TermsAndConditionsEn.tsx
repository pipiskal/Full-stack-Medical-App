...
const TermsAndConditionsEn = () => {
  return (
    <div className={s.content}>
      ...
      <p>
        We are Enospace ('Company', 'we', 'us', or 'our'), a company registered
        in Greece at Athens. We operate the website{' '}
        <a href="http://www.mediapp.com">http://www.mediapp.com</a> (the
        ...
        <a href="mailto:enospacedev@gmail.com">enospacedev@gmail.com</a> or by
        mail to Athens. These Legal Terms constitute a legally binding agreement
        made between you, whether personally or on behalf of an entity ('you'),
        and Enospace, concerning your access to and use of the Services. You
      ...
      <p>
        Greece. We will provide you with prior notice of any scheduled changes
        to the Services you are using. The modified Legal Terms will become
        effective upon posting or notifying you by{' '}
        <a href="mailto:enospacedev@gmail.com">enospacedev@gmail.com</a>, as
      ...
      <p>
        ...
        solely for your internal business purpose. Except as set out in this
        ...
        your request to:{' '}
        <a href="mailto:enospacedev@gmail.com">enospacedev@gmail.com</a>. If we
      ...
      <p>
        <strong>Your submissions:</strong> Please review this section and the
      ...
      <p>
        ...
        change prices at any time. All payments shall be in Euros. You agree to
        ...
        order is subject to recurring charges, then you consent to our charging
        ...
        in pricing, even if we have already requested or received payment. We
      ...
      <p>
        ...
        Services are hosted in Greece. If you access the Services from any other
        ...
        Greece, then through your continued use of the Services, you are
        transferring your data to Greece, and you expressly consent to have your
        data transferred to and processed in Greece.
      </p>
      ...
      <p>
        ...
        Greece, and the use of the United Nations Convention of Contracts for
        ...
        your country of residence. Enospace and yourself both agree to submit to
        the non-exclusive jurisdiction of the courts of Athens, which means that
        you may make a claim to defend your consumer protection rights in
        regards to these Legal Terms in Greece, or in the EU country in which
        you reside.
      </p>
      ...
      <p>
        ...
        clause constitutes acceptance. The seat of arbitration shall be Athens,
        Greece. The language of the proceedings shall be Greek. Applicable rules
        of substantive law shall be the law of Greece.
      </p>
      <p>
        <em>Restrictions</em>
      </p>
      ...
      <p>
        ...
        at: Enospace, Athens, Greece, enospacedev@gmail.com.
      </p>
    </div>
  );
};
